...
This repository contains the source code for the [SBB](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.devcorr.android.sbb).

Please see the [issues](https://github.com.devcorr.android.sbb/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about SBB? Ask away on the [com-devcorr-android-sbb discussion forum](https://groups.google.com/forum/#!forum/com-devcorr-android-sbb). 

<a href="https://play.google.com/store/apps/details?id=com.devcorr.android.sbb" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __com.devcorr.android.sbb__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.devcorr.android.sbb__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.devcorr.android.sbb.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall SBB from your device and
...
You can then import the SBB project by doing File/Import/Gradle/Gradle Project
and the clicking the Browse button to point to the SBB directory.  Click
...
SBB is a result of a template project I've developed over the years as well as
...
SBB is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.devcorr.android.sbb/contributors) on this project. Your help is much appreciated.


## Contributing

Please fork this repository and contribute back using
[pull requests](https://github.com.devcorr.android.sbb/pulls).
